...
estateName.title = Beth yw enw’r ystâd?
estateName.heading = Beth yw enw’r ystâd?
estateName.hint = Mae’n rhaid i hyn fod yn 53 o gymeriadau neu lai.
estateName.checkYourAnswersLabel = Beth yw enw’r ystâd?
estateName.error.length = Mae’n rhaid i enw’r ystâd fod yn 53 o gymeriadau neu lai
estateName.error.invalidCharacters = Mae’n rhaid i enw’r ystâd gynnwys y llythrennau a i z, rhifau, ampersandau (&), collnodau, comas, blaenslaesau, atalnodau llawn, cysylltnodau, cromfachau crwn a bylchau yn unig
estateName.error.required = Nodwch enw’r ystâd
