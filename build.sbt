  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/registerestatedetailsfrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/registerestatedetailsfrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("registerestatedetailsfrontend-*.js")
  )
